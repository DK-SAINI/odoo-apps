...
class ResConfigSettings(models.TransientModel):
    ...
    def action_open_mcp_model_access(self):
        return self.env.ref('mcp_server.action_mcp_model_access').read()[0]

    def action_open_mcp_audit_log(self):
        return self.env.ref('mcp_server.action_mcp_audit_log').read()[0]
    ...
    mcp_logging_enabled = fields.Boolean(
        ...
        config_parameter='mcp_server.logging_enabled',
        default=True,
    )
    mcp_rate_limit = fields.Integer(
        string='Rate Limit (req/min)',
        config_parameter='mcp_server.rate_limit',
        default=10,
    ...
    mcp_allowed_ips = fields.Char(
        string='IP Whitelist',
        config_parameter='mcp_server.allowed_ips',
    ...
    mcp_max_records_per_request = fields.Integer(
        ...
        config_parameter='mcp_server.max_records_per_request',
        default=1000,
    ...
    mcp_cache_enabled = fields.Boolean(
        ...
        config_parameter='mcp_server.cache_enabled',
        default=False,
    )
    mcp_default_cache_ttl = fields.Integer(
        string='Default Cache TTL (seconds)',
        config_parameter='mcp_server.default_cache_ttl',
        default=300,
    ...
    mcp_yolo_mode = fields.Selection(
        ...
        string='YOLO Mode',
        config_parameter='mcp_server.yolo_mode',
        default='disabled',
